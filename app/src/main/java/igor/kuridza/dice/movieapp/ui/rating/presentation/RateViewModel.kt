package igor.kuridza.dice.movieapp.ui.rating.presentation
...
class RateViewModel(
    ...
    private val _rateMessageResponse = MutableLiveData<ViewState<MessageResponse>>()
    val rateMessageResponse: LiveData<ViewState<MessageResponse>>
